...
date: '20250119'
description: Leaked system prompt for anthropic-claude-api-tool-use from 20250119.
name: anthropic-claude-api-tool-use Leaked System Prompt (20250119)
service:
- anthropic-claude-api-tool-use
source:
- file: anthropic-claude-api-tool-use_20250119.md
...
- leaked
- system-prompt
uid: 20250119-anthropic-claude-api-tool-use-anthropic-claude-api-tool-use_20250119
---
